export const weddingFaq = [
  ...
  },
  {
    ...
    answer:
      "Oui. Les préparatifs font pleinement partie du reportage de mariage et permettent souvent de raconter des moments très personnels avant le début de la cérémonie.",
  },
  {
    question: "Est-il possible de faire des photos de groupe ?",
    answer:
      "Bien sûr. Nous pouvons préparer en amont une liste courte des groupes importants afin de réaliser ces photos efficacement sans interrompre longtemps le déroulement de votre journée.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Contactez-moi avec la date et le lieu de votre mariage ainsi que quelques informations sur votre journée. Je vérifie ensuite ma disponibilité et nous échangeons avant de confirmer la réservation.",
  },
  {
